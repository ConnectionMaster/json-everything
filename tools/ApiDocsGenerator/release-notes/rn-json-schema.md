...
[#1035](https://github.com/json-everything/json-everything/pull/1033) - [@LLDevLab](https://github.com/LLDevLab) found a minor memory leak when using `JsonSchema.FromText()`.

# [9.2.0](https://github.com/json-everything/json-everything/pull/1031) {#release-schema-9.2.0}
...
# [9.1.5](https://github.com/json-everything/json-everything/pull/1028) {#release-schema-9.1.5}

Adds `SchemaRegistry.CreateBundle()`.

[#996](https://github.com/json-everything/json-everything/pull/996) - Fixes a validation error message for `pattern`.  Thanks to [@anthonypuppo](https://github.com/anthonypuppo) for submitting the fix.

# [9.1.4](https://github.com/json-everything/json-everything/pull/1015) {#release-schema-9.1.4}

Fixed an issue with `type` keyword and bigint values.

# [9.1.3](https://github.com/json-everything/json-everything/pull/1013) {#release-schema-9.1.3}

Updated nuget packages & EULA.

# [9.1.2](https://github.com/json-everything/json-everything/pull/1010) {#release-schema-9.1.2}

[#977](https://github.com/json-everything/json-everything/issues/977 - Resolves an issue with reusing `JsonNode`s that already have parents.  Issue generally presents when using schema generation.

# [9.1.1](https://github.com/json-everything/json-everything/pull/1003) {#release-schema-9.1.1}

[#999](https://github.com/json-everything/json-everything/issues/999 ([PR](https://github.com/json-everything/json-everything/pull/1000)) - Resolved concurrency issue in `SchemaRegistry`.  Thanks to [@denispaluca](https://github.com/denispaluca) for providing the fix.

# [9.1.0](https://github.com/json-everything/json-everything/pull/991) {#release-schema-9.1.0}

[#986](https://github.com/json-everything/json-everything/issues/986) - Exposed types needed to support source generation in _JsonSchema.Net.Generation_ v7.1.0.  Thanks to [@ThomasNieto](https://github.com/ThomasNieto) for suggesting.

# [9.0.0](https://github.com/json-everything/json-everything/pull/982) {#release-schema-9.0.0}

Enacted Open Source Maintenance Fee.

See the [blog post](https://blog.json-everything.net/posts/expensive/) for more information.

# [8.0.5](https://github.com/json-everything/json-everything/pull/974) {#release-schema-8.0.5}

[#973](https://github.com/json-everything/json-everything/issues/973) - Unable to resolve references inside referenced files.  Thanks to [@ivi-hamiti](https://github.com/ivi-hamiti) for reporting.

# [8.0.4](https://github.com/json-everything/json-everything/pull/967) {#release-schema-8.0.4}

Significant performance improvements.

Schema registration order no longer matters.  (Just be sure you're registering them all.)

[#965](https://github.com/json-everything/json-everything/issues/965) - StackOverflowException when `$ref`-ing into unknown keywords that then references itself.

# [8.0.3](https://github.com/json-everything/json-everything/pull/959) {#release-schema-8.0.3}

Fixes for .Net Framework 4.8.1.

Optimizations for Flag output format.

# [8.0.2](https://github.com/json-everything/json-everything/pull/959) {#release-schema-8.0.2}

Performance improvements for `additionalProperties`, `contains`, `dependentSchemas`, `patternProperties`, and `uniqueItems`.

[#958](https://github.com/json-everything/json-everything/issues/958) - Bug fix in `JsonMath` for when comparing 0 with 0<x<1.

# [8.0.1](https://github.com/json-everything/json-everything/pull/952) {#release-schema-8.0.1}
...
# [8.0.0](https://github.com/json-everything/json-everything/pull/952) {#release-schema-8.0.0}
...
[#881](https://github.com/json-everything/json-everything/issues/881) - Improves `date-time` format validation.  Thanks to [@mauricecamphadrian](https://github.com/mauricecamphadrian) for suggesting and implementing this.
...
[#852](https://github.com/json-everything/json-everything/issues/852) - Improves `hostname` & `idn-hostname` format validation.  Thanks to [@mauricecamphadrian](https://github.com/mauricecamphadrian) for finding this and suggesting a new regex.

# [7.3.2](https://github.com/json-everything/json-everything/pull/870) {#release-schema-7.3.2}

> I'm not sure what changed here.  The intended changes were republished as 7.3.3 (above).  Use that instead.
{: .prompt-info }

# [7.3.1](https://github.com/json-everything/json-everything/pull/822) {#release-schema-7.3.1}

[#844](https://github.com/json-everything/json-everything/issues/844) - Nuspec for this library is manually mananged and gets left behind if a listed dependency is updated.  Added a test to prevent this from happening again.  Updates the dependency on _JsonPointer.Net_ to current latest (v5.1.0).

# [7.3.0](https://github.com/json-everything/json-everything/pull/822) {#release-schema-7.3.0}

Add .Net 9.0 support.

# [7.2.3](https://github.com/json-everything/json-everything/pull/792) {#release-schema-7.2.3}

[#791](https://github.com/json-everything/json-everything/issues/791) - Fixes an issue with `ValidatingConverter` where options weren't being honored for explicitly mapped types.  Thanks to [@pian0](https://github.com/pian0) for reporting and creating replicating tests.

# [7.2.2](https://github.com/json-everything/json-everything/pull/782) {#release-schema-7.2.2}

Fixes an issue with `unevaluated*` keyword output where the instance location would contain repeated pointer segments.

# [7.2.1](https://github.com/json-everything/json-everything/pull/781) {#release-schema-7.2.1}

[#778](https://github.com/json-everything/json-everything/issues/778) - Addresses a potential `IndexOutOfRangeException` that could occur for large schemas.  Thanks to [@Laniusexcubitor](https://github.com/Laniusexcubitor) for bouncing ideas and testing.

# [7.2.0](https://github.com/json-everything/json-everything/pull/776) {#release-schema-7.2.0}

[#773](https://github.com/json-everything/json-everything/issues/773) - [@rikbosch](https://github.com/rikbosch) recommended and patched a performance improvement around regular expression handling.
...
# [7.1.2](https://github.com/json-everything/json-everything/pull/759) {#release-schema-7.1.2}

Update to use _JsonPointer.Net_ v5.0.2.

# [7.1.1](https://github.com/json-everything/json-everything/pull/755) {#release-schema-7.1.1}

Added a backdoor to allow Graeae to support draft 4 schemas.

# [7.1.0](https://github.com/json-everything/json-everything/pull/752) {#release-schema-7.1.0}

Adds `EvaluationOptions.AllowReferencesIntoUnknownKeywords` to optionally disallow `$ref` navigation into unknown keywords.

# [7.0.4](https://github.com/json-everything/json-everything/pull/746) {#release-schema-7.0.4}
...
# [7.0.3](https://github.com/json-everything/json-everything/commit/f63f73cb0b4d1fc3158e01cac1df5b8acb5e092c) {#release-schema-7.0.3}
...
# [7.0.2](https://github.com/json-everything/json-everything/pull/730) {#release-schema-7.0.2}

[#726](https://github.com/json-everything/json-everything/issues/726) - [@filzrev](https://github.com/filzrev) discovered a thread-safety issue.

# [7.0.1](https://github.com/json-everything/json-everything/pull/724) {#release-schema-7.0.1}
...
# [7.0.0](https://github.com/json-everything/json-everything/pull/719) {#release-schema-7.0.0}
...
# [6.1.1](https://github.com/json-everything/json-everything/pull/717) {#release-schema-6.1.1}

Fixed an exception message.

# [6.1.0.x](https://github.com/json-everything/json-everything/pull/712) {#release-schema-6.1.0.x}
...
# [6.1.0](https://github.com/json-everything/json-everything/pull/709) {#release-schema-6.1.0}

[#704](https://github.com/json-everything/json-everything/issues/704) - Several builder extension return types expanded from `IReadOnlyCollection<T>` to `IReadOnlyList<T>`.  Thanks to [@SGStino](https://github.com/SGStino) for identifying and implementing this.

# [6.0.7](https://github.com/json-everything/json-everything/pull/698) {#release-schema-6.0.7}

[#697](https://github.com/json-everything/json-everything/issues/697) - `allOf`, `anyOf`, `oneOf`, and `prefixItems` all require at least one subschema, but deserialization of these keywords didn't enforce this.  Fix will throw `ArgumentException` when attempting to deserialize empty subschema sets.  Thanks to [@Era-cell](https://github.com/Era-cell) for reporting this.

# [6.0.6](https://github.com/json-everything/json-everything/pull/695) {#release-schema-6.0.6}
...
# [6.0.5](https://github.com/json-everything/json-everything/pull/691) {#release-schema-6.0.5}

[#690](https://github.com/json-everything/json-everything/issues/690) - Fixes an issue with `$anchor` validation in 2020-12.  Thanks to [@Era-cell](https://github.com/Era-cell) for reporting this.

Fixed an issue with legacy output serialization.

# [6.0.4](https://github.com/json-everything/json-everything/pull/678) {#release-schema-6.0.4}

[#677](https://github.com/json-everything/json-everything/issues/677) - Fixes an issue with serializing schemas that use custom keywords when those keywords are not registered with a `JsonTypeInfo` because reflection is okay.  Thanks to [@ProTip](https://github.com/ProTip) for reporting this and providing a reproduction.

# [6.0.3](https://github.com/json-everything/json-everything/pull/660) {#release-schema-6.0.3}
...
# [6.0.2](https://github.com/json-everything/json-everything/pull/651) {#release-schema-6.0.2}
...
# [6.0.0 & 6.0.1](https://github.com/json-everything/json-everything/pull/619) {#release-schema-6.0.0}
...
# [5.5.1](https://github.com/json-everything/json-everything/pull/616) {#release-schema-5.5.1}

Fix typo in `minProperties` error message.  Thanks to [@ArmaanMcleod](https://github.com/ArmaanMcleod) for submitting this fix.

# [5.5.0](https://github.com/json-everything/json-everything/pull/606) {#release-schema-5.5.0}

[#604](https://github.com/json-everything/json-everything/pull/604) - Performance improvements.  Thanks to [@danielstarck](https://github.com/danielstarck) for contributing these.

[#605](https://github.com/json-everything/json-everything/pull/605) - Support external types for validating JSON converter.

# [5.4.3](https://github.com/json-everything/json-everything/pull/601) {#release-schema-5.4.3}

[#600](https://github.com/json-everything/json-everything/issues/600) - Reported schema location not correct for JSON Schemas embedded within non-schema JSON documents (e.g. OpenAPI).  Thanks to [@Fresa](https://github.com/Fresa) for reporting.

# [5.4.2](https://github.com/json-everything/json-everything/pull/575) {#release-schema-5.4.2}

[#574](https://github.com/json-everything/json-everything/issues/574) - Bundling multi-schema recursion throws an exception.  Thanks to [@Tommyknocker1982](https://github.com/Tommyknocker1982) for reporting.

# [5.4.1](https://github.com/json-everything/json-everything/pull/572) {#release-schema-5.4.1}

[#570](https://github.com/json-everything/json-everything/issues/570) - RFC 3339 date/times require the time zone offset.  Thanks to [@danielstarck](https://github.com/danielstarck) for identifying and fixing this issue.

# [5.4.0](https://github.com/json-everything/json-everything/pull/565) {#release-schema-5.4.0}

[#549](https://github.com/json-everything/json-everything/issues/549) - Expose JSON converters for all types to support JSON source generation.

# [5.3.1](https://github.com/json-everything/json-everything/pull/534) {#release-schema-5.3.1}

[#550](https://github.com/json-everything/json-everything/issues/550) - Fixed a stack overflow that would occur with `ValidatingJsonConverter` when using multiple options objects.  Thanks to [@EmmyDream](https://github.com/EmmyDream) for reporting.

# [5.3.0](https://github.com/json-everything/json-everything/pull/534) {#release-schema-5.3.0}
...
# [5.2.7](https://github.com/json-everything/json-everything/pull/534) {#release-schema-5.2.7}
...
# [5.2.6](https://github.com/json-everything/json-everything/pull/534) {#release-schema-5.2.6}
...
# [5.2.5](https://github.com/json-everything/json-everything/pull/522) {#release-schema-5.2.5}
...
# [5.2.4](https://github.com/json-everything/json-everything/commit/825e59424e55600da5be3f52c86b7ef68be91bba) {#release-schema-5.2.4}

`minItmes` was using the `maxItems` error message.  Classic copy/paste error.

# [5.2.3](https://github.com/json-everything/json-everything/pull/521) {#release-schema-5.2.3}
...
# [5.2.2](https://github.com/json-everything/json-everything/pull/518) {#release-schema-5.2.2}

[#516](https://github.com/json-everything/json-everything/issues/516) - `JsonSchemaBuilder.Build()` throws an exception when multiple unrecognized keywords have been added.  Thanks to [@mdekrey](https://github.com/mdekrey) for finding this and suggesting the fix.
[#517](https://github.com/json-everything/json-everything/issues/517) - Deserialization of `JsonSchema` does not correctly report line numbers and positions in source JSON text.  Thanks to [@mdekrey](https://github.com/mdekrey) for finding this and implementing the fix.

# [5.2.1](https://github.com/json-everything/json-everything/pull/514) {#release-schema-5.2.1}

[#511](https://github.com/json-everything/json-everything/pull/511) - `JsonNodeBaseDocument` had some concurrency issues.  Thanks to [@Fresa](https://github.com/Fresa) for finding and fixing this issue.

# [5.2.0](https://github.com/json-everything/json-everything/pull/505) {#release-schema-5.2.0}
...
[#504](https://github.com/json-everything/json-everything/issues/504) - Fixed bug for `JsonSchema.GetKeyword()` and `JsonSchema[string]`.  These should return null if the keyword doesn't exist but would throw exceptions.  Thanks to [@mirkoSekulic](https://github.com/mirkoSekulic) for reporting this.

[#506](https://github.com/json-everything/json-everything/issues/506) - Fixed bug for `JsonSchema.FindSubschema()` where the pointer lead into a keyword that held a single subschema, e.g. `additionalProperties`.  Thanks to [@Splamy](https://github.com/Splamy) for reporting this.

# [5.1.3](https://github.com/json-everything/json-everything/commit/fe728123a712a43bad6f8a51a625e41f9d459925) {#release-schema-5.1.3}
...
# [5.1.2](https://github.com/json-everything/json-everything/commit/d3a3838882747bb1130860df43cf8ce1fbc48e24) (unlisted) {#release-schema-5.1.2}

This one, too.

Fixing 👇.  Test your code, folks!

# [5.1.1](https://github.com/json-everything/json-everything/commit/db49b4c2c062c0ab6f258f5fe6e355d947157e83) (unlisted) {#release-schema-5.1.1}

Just ignore this.

Added `SchemaConstraint.GetLocalSchema()` for accessing the local schema.  (To be used as a last resort, but may be necessary.)

# [5.1.0](https://github.com/json-everything/json-everything/pull/499) {#release-schema-5.1.0}

[#493](https://github.com/json-everything/json-everything/issues/493) - Add support for reporting error messages in multiple cultures in parallel.  Thanks to [@m-adamkiewicz](https://github.com/m-adamkiewicz) for the suggestion.

# [5.0.0](https://github.com/json-everything/json-everything/pull/494) {#release-schema-5.0.0}
...
# [4.1.8](https://github.com/json-everything/json-everything/pull/490) {#release-schema-4.1.8}

Fixes several issues where keyword names were not reported in the evaluation path in the output.

# [4.1.7](https://github.com/json-everything/json-everything/commit/21b1fe73393508d84c90d00cc8f22aeaa958a2b5) {#release-schema-4.1.7}

Update keyword selection for custom drafts (support for upcoming OpenAPI project).

# [4.1.6](https://github.com/json-everything/json-everything/commit/6adac438c32d5324f3b9826db758a5f8b73ffe0f) {#release-schema-4.1.6}
...
# [4.1.4](https://github.com/json-everything/json-everything/pull/473) {#release-schema-4.1.4}
...
# [4.1.3](https://github.com/json-everything/json-everything/pull/470) {#release-schema-4.1.3}

[#457](https://github.com/json-everything/json-everything/issues/457) - [@pawel-wachalski](https://github.com/pawel-wachalski) added Norwegian and Swedish as supported translations for error messages.

# [4.1.2](https://github.com/json-everything/json-everything/pull/469) {#release-schema-4.1.2}

[#468](https://github.com/json-everything/json-everything/issues/468) - [@Fresa](https://github.com/Fresa) found that `JsonNodeBaseDocument` doesn't properly resolve references in schemas that it contatins and proposed the fix.

# [4.1.1](https://github.com/json-everything/json-everything/pull/447) {#release-schema-4.1.1}
...
# [4.1.0](https://github.com/json-everything/json-everything/pull/443) {#release-schema-4.1.0}
...
# [4.0.7](https://github.com/json-everything/json-everything/pull/442) {#release-schema-4.0.7}

v4.0.1 used an ISO 8601 regex to enable higher-precision support.  This has been corrected to use an RFC 3339 regex instead for proper JSON Schema support.  However, as reported in [#439](https://github.com/json-everything/json-everything/issues/439), .Net doesn't like deserialization of RFC 3339 date-times.

# [4.0.6](https://github.com/json-everything/json-everything/pull/436) {#release-schema-4.0.6}
...
# [4.0.5](https://github.com/json-everything/json-everything/pull/434) {#release-schema-4.0.5}

[#432](https://github.com/json-everything/json-everything/issues/432) - Local `$ref`s that occur at the root of a draft 6 or 7 schema cause nested `$ref`s in the same schema resource to fail.  Thanks to [@Jeroen-VDW](https://github.com/Jeroen-VDW) for following up.

# [4.0.4](https://github.com/json-everything/json-everything/pull/433) {#release-schema-4.0.4}

[#432](https://github.com/json-everything/json-everything/issues/432) - Local `$ref`s that occur at the root of a draft 6 or 7 schema don't resolve.  Thanks to [@Jeroen-VDW](https://github.com/Jeroen-VDW) for reporting this issue.

# [4.0.3](https://github.com/json-everything/json-everything/pull/427) {#release-schema-4.0.3}

[#426](https://github.com/json-everything/json-everything/issues/426) - `$ref`s that pointed to schemas with `file://` URIs don't resolve correctly.  Thanks to [@faldor20](https://github.com/faldor20) for finding and fixing this issue.

# [4.0.2](https://github.com/json-everything/json-everything/pull/423) {#release-schema-4.0.2}

[#419](https://github.com/json-everything/json-everything/issues/419) - Fixed an issue with schema registration and populating IDs.  Thanks to [@lennver](https://github.com/lennver) for providing reproduction for this issue.

# [4.0.1](https://github.com/json-everything/json-everything/pull/418) {#release-schema-4.0.1}
...
# [4.0.0](https://github.com/json-everything/json-everything/pull/326) {#release-schema-4.0.0}
...
# [3.3.2](https://github.com/json-everything/json-everything/pull/347) {#release-schema-3.3.2}
...
# [3.3.1](https://github.com/json-everything/json-everything/pull/346) {#release-schema-3.3.1}
...
# [3.3.0](https://github.com/json-everything/json-everything/pull/344) {#release-schema-3.3.0}

[#340](https://github.com/json-everything/json-everything/issues/340) - Added `ValidationOptions.ProcessCustomKeywords` to allow custom keywords for schema versions 2019-09 and later.

# [3.2.1](https://github.com/json-everything/json-everything/pull/330) {#release-schema-3.2.1}
...
# [3.2.0](https://github.com/json-everything/json-everything/pull/300) {#release-schema-3.2.0}
...
# [3.1.5](https://github.com/json-everything/json-everything/pull/299) {#release-schema-3.1.5}
...
# [3.1.3](https://github.com/json-everything/json-everything/pull/297) {#release-schema-3.1.3}
...
# [3.1.2](https://github.com/json-everything/json-everything/pull/294) {#release-schema-3.1.2}
...
# [3.1.0](https://github.com/json-everything/json-everything/pull/285) {#release-schema-3.1.0}

[#284](https://github.com/json-everything/json-everything/issues/284) - Added optional `JsonSerializerOptions` parameter in `JsonSchema.FromFile()`, `.FromText()`, and `.FromStream()`.

# [3.0.0](https://github.com/json-everything/json-everything/pull/280) {#release-schema-3.0.0}
...
# [2.4.0](https://github.com/json-everything/json-everything/pull/270) {#release-schema-2.4.0}
...
# [2.3.0](https://github.com/json-everything/json-everything/pull/249) {#release-schema-2.3.0}

[#190](https://github.com/json-everything/json-everything/issues/190) - Added support for custom and localized error messages.
...
# [2.2.1](https://github.com/json-everything/json-everything/pull/247) {#release-schema-2.2.1}

[#243](https://github.com/json-everything/json-everything/pull/243) - Updated System.Text.Json to version 6.

[#245](https://github.com/json-everything/json-everything/issues/245) - [@ItsVeryWindy](https://github.com/ItsVeryWindy) identified where `allOf` was reporting locations incorrectly in validation output.

[#246](https://github.com/json-everything/json-everything/issues/246) - [@YaroslavHuriev](https://github.com/YaroslavHuriev) noticed an issue with some formats where non-strings were not properly ignored.  As part of this fix, `Format.Validate(JsonElement)` was marked obsolete as it has been replaced and is no longer called.  It will be removed with the next major version.

# [2.2.0](https://github.com/json-everything/json-everything/pull/239) {#release-schema-2.2.0}

[#238](https://github.com/json-everything/json-everything/pull/238) - [@WeihanLi](https://github.com/WeihanLi) added extenion methods to create schemas directly from `JsonDocument` and strings that contain JSON data.

# [2.1.2](https://github.com/json-everything/json-everything/pull/230) {#release-schema-2.1.2}

[#220](https://github.com/json-everything/json-everything/issues/220) - References to deeply nested subschemas could not be resolved through keywords that contained a single schema.
...
# [2.1.1](https://github.com/json-everything/json-everything/pull/227) {#release-schema-2.1.1}

[#226](https://github.com/json-everything/json-everything/issues/226) - Fixed an issue with including unneeded nodes in Basic output.

# [2.1.0](https://github.com/json-everything/json-everything/pull/218) {#release-schema-2.1.0}
...
# [2.0.3](https://github.com/json-everything/json-everything/pull/217) {#release-schema-2.0.3}

[#216](https://github.com/json-everything/json-everything/issues/208) - `additionalProperties` does not determine the correct property set to evaluate for drafts 6 and 7. Reported by [@joyse1](https://github.com/joyse1).

Fixed a bug in keyword filtering for subschemas.

# [2.0.2](https://github.com/json-everything/json-everything/pull/213) {#release-schema-2.0.2}

[#208](https://github.com/json-everything/json-everything/issues/208) - [@ItsVeryWindy](https://github.com/ItsVeryWindy) discovered a regression where resolve local references to definitions located inside a bundled schema fail to resolve.

# [2.0.1](https://github.com/json-everything/json-everything/pull/210) {#release-schema-2.0.1}

[#207](https://github.com/json-everything/json-everything/issues/207) - [@ItsVeryWindy](https://github.com/ItsVeryWindy) discovered a regression where bundling (embedding a schema of one draft inside a schema of another) fails to process the required keyword set.

# [2.0.0](https://github.com/json-everything/json-everything/pull/200) {#release-schema-2.0.0}
...
# [1.13.0](https://github.com/json-everything/json-everything/pull/204) {#release-schema-1.13.0}

[#203](https://github.com/json-everything/json-everything/issues/203) - [@coderpatros](https://github.com/coderpatros) discovered a regression in `format` validation when the format is unkonwn.
...
# [1.12.0](https://github.com/json-everything/json-everything/pull/196) {#release-schema-1.12.0}

[#191](https://github.com/json-everything/json-everything/issues/191) - Self-referencing meta-schemas cause an infinite loop during validation.

[#193](https://github.com/json-everything/json-everything/issues/193) - Custom format validations don't provide sufficient information and don't cause validation to fail when assertion is required.

- Added `UnknownFormat` and `Format.CreateUnknown`.
- Added `JsonSchemaBuilder.Format(string)` which looks up the format key.

# [1.11.6](https://github.com/json-everything/json-everything/pull/189) {#release-schema-1.11.6}
...
# [1.11.5](https://github.com/json-everything/json-everything/pull/179) {#release-schema-1.11.5}

Updated JsonPointer.Net to v2.0.0.  Please see [release notes](./json-pointer.md) for that library as it contains breaking changes.

# [1.11.4](https://github.com/json-everything/json-everything/pull/176) {#release-schema-1.11.4}

[#175](https://github.com/json-everything/json-everything/pull/175) - [@ranma42](https://github.com/ranma42) tidied up the schema registry initialization code, also resolving some concurrency issues.

# [1.11.3](https://github.com/json-everything/json-everything/pull/166) {#release-schema-1.11.3}

[#165](https://github.com/json-everything/json-everything/issues/165) - [@pbajrak](https://github.com/pbajrak) discovered a copy/paste error in the message for `minProperties`.

# [1.11.2](https://github.com/json-everything/json-everything/pull/157) {#release-schema-1.11.2}

Fixed minor issue with `$dynamicRef`/`$dynamicAnchor` and resolution within specific scopes.

# [1.11.1](https://github.com/json-everything/json-everything/pull/156) {#release-schema-1.11.1}
...
# [1.11.0](https://github.com/json-everything/json-everything/pull/155) {#release-schema-1.11.0}

`format` incorporates error messages from custom format validation, when provided.

# [1.10.8](https://github.com/json-everything/json-everything/pull/152) {#release-schema-1.10.8}

`format` now adds an error message.

# [1.10.7](https://github.com/json-everything/json-everything/pull/145) {#release-schema-1.10.7}

Revenge of [#138](https://github.com/json-everything/json-everything/issues/138) - [@yohny](https://github.com/yohny) found that the initialization issue still existed when not supplying custom validation options.

# [1.10.6](https://github.com/json-everything/json-everything/pull/140) {#release-schema-1.10.6}

[#138](https://github.com/json-everything/json-everything/issues/138) - [@wazzamatazz](https://github.com/wazzamatazz) found an initialization issue that resulted in a `NullReferenceException`.

# [1.10.5](https://github.com/json-everything/json-everything/pull/135) {#release-schema-1.10.5}

Fixed an issue with reference resolution when `$ref` and `$id` are sibling keywords in drafts 6 and 7.

# [1.10.4](https://github.com/json-everything/json-everything/pull/133) {#release-schema-1.10.4}
...
# [1.10.3](https://github.com/json-everything/json-everything/pull/120) {#release-schema-1.10.3}
...
# [1.10.2](https://github.com/json-everything/json-everything/pull/102) {#release-schema-1.10.2}

In 2020-12, `unevaluatedItems` should consider `contains`.

# [1.10.1](https://github.com/json-everything/json-everything/pull/98) {#release-schema-1.10.1}

[#97](https://github.com/json-everything/json-everything/issues/97) - Added support for circular reference detection.

# [1.10.0](https://github.com/json-everything/json-everything/pull/93) {#release-schema-1.10.0}

[#90](https://github.com/json-everything/json-everything/issues/90) - Added `JsonSchemaBuilder.Get<T>()` to support the discussion around incrementally adding properties while building schemas.

Added optional logging around schema processing decisions.

# [1.9.4](https://github.com/json-everything/json-everything/pull/92) {#release-schema-1.9.4}
...
# [1.9.3](https://github.com/json-everything/json-everything/pull/83) {#release-schema-1.9.3}

[#82](https://github.com/json-everything/json-everything/pull/82) - Fixing issues managing `ValidationContext.CurrentUri`.  Credit to [@amosonn](https://github.com/amosonn).

# [1.9.2](https://github.com/json-everything/json-everything/pull/80) {#release-schema-1.9.2}

[#79](https://github.com/json-everything/json-everything/issues/79) - `$ref` was calling out to resolve a parent URI.

# [1.9.1](https://github.com/json-everything/json-everything/pull/77) {#release-schema-1.9.1}
...
# [1.9.0](https://github.com/json-everything/json-everything/pull/75) {#release-schema-1.9.0}
...
Fixed [#76](https://github.com/json-everything/json-everything/issues/76) - `.GetHashCode()` is inconsistent for schemas and keywords.  Credit to [@amosonn](https://github.com/amosonn) for pointing me to a good hash code method in the wild.
...
# [1.8.0](https://github.com/json-everything/json-everything/pull/72) {#release-schema-1.8.0}

Exposed `UriExtensions` to help support new keywords that manipulate URIs.

# [1.7.1](https://github.com/json-everything/json-everything/pull/68) {#release-schema-1.7.1}

Fixed [#67](https://github.com/json-everything/json-everything/issues/67) - `enum` keyword serializes as `examples` due to a copy-paste error.  Credit to [@dannyheard7](https://github.com/dannyheard7) for finding and fixing.  Also fixed several other related serialization issues.

# [1.7.0](https://github.com/json-everything/json-everything/pull/65) {#release-schema-1.7.0}
...
# [1.6.1](https://github.com/json-everything/json-everything/pull/61) {#release-schema-1.6.1}

Signed the DLL for strong name compatibility.

# [1.6.0](https://github.com/json-everything/json-everything/pull/52) {#release-schema-1.6.0}
...
# [1.5.4](https://github.com/json-everything/json-everything/pull/45) {#release-schema-1.5.4}

Added debug symbols to package.  No functional change.

# [1.5.3](https://github.com/json-everything/json-everything/pull/41) {#release-schema-1.5.3}

Fixed `NullReferenceException` when comparing two schemas.

# [1.5.2](https://github.com/json-everything/json-everything/pull/40) {#release-schema-1.5.2}
...
# [1.5.1](https://github.com/json-everything/json-everything/pull/34) {#release-schema-1.5.1}

[#35](https://github.com/json-everything/json-everything/issues/35) `JsonSchema.FromFile()` handles file paths as URIs incorrectly in non-Windows systems. 

# [1.5.0](https://github.com/json-everything/json-everything/pull/34) {#release-schema-1.5.0}

[#33](https://github.com/json-everything/json-everything/issues/33) Added `ValidationOptions.ValidateFormat` which allows configuration of whether to validate the `format` keyword.  Also fixes a bug where the `format` keyword was validated by default for draft 2019-09 which specifies that it should only generate annotations by default.  Because this library favors the latest draft, this is the default behavior for all drafts.

As a further followup to #27 (below), basic output has been refined.

# [1.4.0](https://github.com/json-everything/json-everything/pull/31) {#release-schema-1.4.0}

[#27](https://github.com/json-everything/json-everything/issues/27) (reopened) Better reduction of detailed output format which eliminates the notion that any nodes *must* be kept.

[#29](https://github.com/json-everything/json-everything/issues/29) Relative `$id` keyword at root of schema was not supported.  Added `ValidationOptions.DefaultBaseUri` to be used when no other absolute URI is defined by the `$id` keyword.  Also now supports assuming the base URI from the file name.

# [1.3.1](https://github.com/json-everything/json-everything/pull/28) {#release-schema-1.3.1}

[#27](https://github.com/json-everything/json-everything/issues/27) Nodes in the basic and detailed output formats that match the overall outcome should be removed.  This also addresses several other bugs involving the output such as `absoluteKeywordLocation`.

# [1.3.0](https://github.com/json-everything/json-everything/pull/25) {#release-schema-1.3.0}

[#15](https://github.com/json-everything/json-everything/issues/15) Easier navigation of the schema and its subschemas. Added `ISchemaContainer`, `ISchemaCollector`, and `IKeyedSchemaCollector` for the varying sets of subschemas that keywords can have.  Added `SchemaKeywordExtensions.GetSubschemas()` extension method.

[#19](https://github.com/json-everything/json-everything/issues/19) Keyword filtering doesn't consider declared draft or `ValidationOptions.ValidateAs`.

# [1.2.0](https://github.com/json-everything/json-everything/pull/17) {#release-schema-1.2.0}
...
[#16](https://github.com/json-everything/json-everything/issues/16) `JsonSchema` equality checking.  Along with this, added `IEquatable<T>` to `SchemaKeywordRegistry.Register<T>()`.

[#18](https://github.com/json-everything/json-everything/issues/18) `properties` keyword is processed with same priority as `additionalProperties` making keyword order important, but it shouldn't be.

Added `EnumerableExtensions.ContentsEqual()`.

# [1.1.0](https://github.com/json-everything/json-everything/pull/11) {#release-schema-1.1.0}

Added `SchemaRegistry.Fetch` property to enable automatic downloading of referenced schemas.

# [1.0.3](https://github.com/json-everything/json-everything/pull/11) {#release-schema-1.0.3}

[#9](https://github.com/json-everything/json-everything/pull/11) `if`/`then`/`else` are processed in serialized order instead of processing `if` first.

[#10](https://github.com/json-everything/json-everything/pull/10) Bug fix around deserialization of `readonly` keyword.

# [1.0.2](https://github.com/json-everything/json-everything/pull/7) {#release-schema-1.0.2}

Updated format `json-pointer` to require plain pointers.  URI-encoded pointers are invalid.

# [1.0.1](https://github.com/json-everything/json-everything/pull/6) {#release-schema-1.0.1}
